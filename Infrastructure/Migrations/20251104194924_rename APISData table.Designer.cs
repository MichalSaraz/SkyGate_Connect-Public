...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251104194924_rename APISData table")]
    partial class renameAPISDatatable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.FlightContext.BaseFlight", b =>
                {
                    ...
                    b.Property<DateTime?>("UTCArrivalDateTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime>("UTCDepartureDateTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Core.FlightContext.ScheduledFlight", b =>
                {
                    ...
                    b.Property<string>("ArrivalTimesInLocalTime")
                        .HasColumnType("jsonb");

                    b.Property<string>("ArrivalTimesInUTCTime")
                        .HasColumnType("jsonb");

                    b.Property<string[]>("Codeshare")
                        .HasColumnType("text[]");

                    b.Property<string>("DepartureTimesInLocalTime")
                        .HasColumnType("jsonb");

                    b.Property<string>("DepartureTimesInUTCTime")
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Core.PassengerContext.TravelDocument.Country", b =>
                {
            ...
            modelBuilder.Entity("Core.PassengerContext.TravelDocument.TravelDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Core.FlightContext.FlightInfo.Aircraft", b =>
                {
                    ...
                    b.HasOne("Core.PassengerContext.TravelDocument.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.PassengerContext.TravelDocument.TravelDocument", b =>
                {
                    b.HasOne("Core.PassengerContext.TravelDocument.Country", "CountryOfIssue")
                        .WithMany()
                        .HasForeignKey("CountryOfIssueId");

                    b.HasOne("Core.PassengerContext.TravelDocument.Country", "Nationality")
                        .WithMany()
