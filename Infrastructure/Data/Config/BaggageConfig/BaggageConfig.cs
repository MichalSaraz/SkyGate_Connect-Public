...
namespace Infrastructure.Data.Config.BaggageConfig;

/// <summary>
/// Configures the entity type for the <see cref="Baggage"/> class.
/// </summary>
public class BaggageConfig : IEntityTypeConfiguration<Baggage>
{
    /// <summary>
    /// Configures the properties and relationships of the <see cref="Baggage"/> entity.
    /// </summary>
